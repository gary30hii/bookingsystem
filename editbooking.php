...
<body>
    ...
    <nav class="navbar sticky-top navbar-expand-lg navbar-dark bg-dark" style="background-color: 1F1F1F;">
        <div class="container">
            <a class="navbar-brand" href="#">AiBlog</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="blogposts.php">Posts</a>
                    </li>
                    <li class="nav-item">
